						...
						<div className="flex justify-center mb-6">
							<div className="relative">
								...
								<div className="relative bg-white rounded-full p-6 shadow-lg">
									<CheckCircle className="h-16 w-16 text-[#0b4d2b]" />
								</div>
							</div>
						</div>
						<h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Family Approval from CRC</h1>
						<p className="text-xl text-green-100">Community Resource Center Approval Process</p>
					</div>
