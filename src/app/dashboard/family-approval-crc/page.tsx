...
import { ArrowLeft, Clock, Construction, CheckCircle, Users } from "lucide-react";
						...
						<div className="flex justify-center mb-3">
							<div className="relative">
								...
								<div className="relative bg-white rounded-full p-3 shadow-lg">
									<CheckCircle className="h-10 w-10 text-[#0b4d2b]" />
								</div>
							</div>
						</div>
						<h1 className="text-2xl md:text-3xl font-bold text-white mb-1">Family Approval from CRC</h1>
						<p className="text-sm text-green-100">Community Resource Center Approval Process</p>
					</div>
