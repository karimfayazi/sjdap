						...
						<div className="flex justify-center mb-6">
							<div className="relative">
								...
								<div className="relative bg-white rounded-full p-6 shadow-lg">
									<Construction className="h-16 w-16 text-[#0b4d2b]" />
								</div>
							</div>
						</div>
						<h1 className="text-4xl md:text-5xl font-bold text-white mb-4">ROPs</h1>
						<p className="text-xl text-green-100">Results and Outputs Progress</p>
					</div>
