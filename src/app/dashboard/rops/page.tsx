...
export default function ROPsPage() {
	...
	// Only users with ROPs = 1/TRUE can access this page
	if (hasAccess === false) {
		return <SectionAccessDenied sectionName={sectionName} requiredPermission="ROPs" />;
	}
				...
				<div className="bg-white rounded-xl shadow-xl overflow-hidden">
					...
					<div className="bg-gradient-to-r from-[#0b4d2b] via-[#0a5d2e] to-[#0b4d2b] px-6 py-4 text-center">
						...
						<div className="flex items-center justify-center gap-3 mb-1">
							...
							<div className="mt-1">
								<PermissionStatusLabel permission="ROP" showIcon={true} className="bg-white/20 text-white border-white/30" />
							</div>
						</div>
